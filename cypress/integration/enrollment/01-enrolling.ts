...
const fixtureData = [
  { startDate: '2022-06-07T00:00:00', endDate: '2022-06-12T00:00:00', display: 'Jun 7, 2022 - Jun 12, 2022 (5 days)' },
...
describe('enrolling for a course', () => {
  ...
  it('the dates are displayed properly', () => {
    cy.get('[data-enrollment-date-list]>option').each((option:HTMLOptionElement, idx) => {
    ...
    beforeEach(() => {
      cy.intercept('POST', '/api/registrations', {
        ...
        body:{
          ...
          "dateOfCourse": "2022-06007T00:00:00",
          "user": "Sue",
          "status": "PENDING"
        }
        })
